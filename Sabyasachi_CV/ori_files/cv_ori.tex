...
\begin{minipage}[h]{0.3\textwidth} % Adjust width as needed
    \centering
    \hspace{1cm}
    % \vspace{2cm} 
...
\begin{minipage}[t]{0.6\textwidth}
    \namesection{Sabyasachi}{Chakrabarty}{ % Your name profile or other web address
    ...
    % \hspace{2cm}
    % \hfill % Push remaining content to the right
    % \includegraphics[width=3.5cm,height=4cm]{images/Profile_photo.JPG}
}
\end{minipage}
...
% \hspace{-0.1cm} % Adjust horizontal spacing as needed
% \includegraphics[width=3.5cm,height=4cm]{images/Profile_photo.JPG}
